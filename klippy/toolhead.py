...
class ToolHead:
    ...
    def _process_moves(self, moves):
        ...
        for move in moves:
            start_pos_alpha = move.start_pos[0]
            axis_alpha = move.axes_r[0]
            start_pos_beta = move.start_pos[3]
            axis_beta = move.axes_r[3]
            self.trapq_append(
                self.trapq, next_move_time,
                move.accel_t, move.cruise_t, move.decel_t,
                start_pos_alpha, start_pos_beta, move.start_pos[2],
                axis_alpha, axis_beta, move.axes_r[2],
