...
class ExtruderStepper:
    def __init__(self, config):
        ...
        self.sk_extruder = ffi_main.gc(ffi_lib.extruder_stepper_alloc(ka, kb), ffi_lib.free)
...
class PrinterExtruder:
    ...
    def move(self, print_time, move):
        ...
        if axis_r:
            ...
            axis_beta = 1.
            axis_alpha = move.axes_r[0]/move.axes_r[3]
        else:
            accel = move.accel
            start_v = move.start_v
            cruise_v = move.cruise_v
            axis_beta = 0.
            axis_alpha = move.axes_r[0]
        if axis_r > 0. and (move.axes_d[0] or move.axes_d[1]):
            can_pressure_advance = True        
        # Queue movement (x: beta, y: pressure advance flag, z: alpha)
        self.trapq_append(self.trapq, print_time,
                          move.accel_t, move.cruise_t, move.decel_t,
                          move.start_pos[3], 0., move.start_pos[0],
                          axis_beta, can_pressure_advance, axis_alpha,
