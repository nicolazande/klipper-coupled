...
SOURCE_FILES = [
    ...
    'kin_extruder.c', 'kin_shaper.c', 'kin_idex.c', 'kin_coupled.c',
]
...
defs_kin_extruder = """
    struct stepper_kinematics *extruder_stepper_alloc(double ka, double kb);
...
defs_kin_coupled = """
    struct stepper_kinematics * coupled_stepper_alloc(double ka, double kb);
"""
...
defs_all = [
    ...
    defs_kin_extruder, defs_kin_shaper, defs_kin_idex, defs_kin_coupled,
]
